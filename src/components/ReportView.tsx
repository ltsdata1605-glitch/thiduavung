...
export const ReportView: React.FC<ReportViewProps> = ({
  ...
  const [sortField, setSortField] = useState<keyof StoreRecord | 'rate'>('rate');
          ...
          <div className="export-hide flex flex-nowrap items-center gap-2 overflow-x-auto max-w-full shrink-0 ml-auto">
            <div className="relative w-44 xl:w-52 shrink-0">
              ...
              <input
                ...
                className="w-full bg-white border border-slate-200 rounded-xl pl-9 pr-3 py-1.5 text-xs text-slate-800 placeholder-slate-400 focus:outline-hidden focus:ring-2 focus:ring-indigo-500"
              />
            </div>
