    ...
    <div className="animate-fade-in">
      ...
      <div className="p-4 md:p-6 space-y-6">
        ...
        {entityScope === 'tong' ? (
          ...
          <div className="w-full max-w-5xl mx-auto bg-white rounded-none border border-slate-200 shadow-2xs overflow-hidden pb-1 my-2">
            {/* Content Captured in Image: Header Banner + Unified Table */}
            <div className="w-full p-3">
              {/* Header Banner - Size chữ lớn, phong cách Tab Nhóm */}
                    ...
                    <tbody className="divide-y divide-slate-200">
                      {storesByChannel.map((group) => (
                        <React.Fragment key={group.channel}>
                          {/* Dòng Tiêu đề Kênh với màu riêng biệt theo Tab Nhóm */}
                      ...
                      {/* DÒNG TỔNG CỘNG TOÀN TỈNH / TOÀN VÙNG Ở CUỐI BẢNG */}
